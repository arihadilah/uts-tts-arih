...
function submitString(concat, tipe, tabel) {
    if (concat.toUpperCase() == "JAVASCRIPT" && tipe == "d1") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "HTML" && tipe == "d2") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "NODEJS" && tipe == "d3") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "CSS" && tipe == "d4") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "FRAMEWORK" && tipe == "m1") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "API" && tipe == "m2") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "SEMANTIC" && tipe == "m3") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "HTTP" && tipe == "m4") {
        pengulanganTabel(tabel);
    } 
}
